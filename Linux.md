...
3. `epoll`
    epoll可以理解为event poll, **底层数据结构为红黑树**，不同无差别轮询，**epoll会把哪个流发生了怎样的I/O事件通知我们, 此时时间复杂度降低到了O(1)*![图 10](images/812363b07e8970563ce50d9b6c58d8f173da26aef8727ecc6f9203688835d5ee.png)  
*
